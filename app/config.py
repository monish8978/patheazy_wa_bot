...
class Settings(BaseSettings):
    DATABASE_URL: str = "mysql+aiomysql://bob_user:bob_password@localhost:3306/patheazy_db"
    DATABASE_SYNC_URL: str = "mysql+pymysql://bob_user:bob_password@localhost:3306/patheazy_db"
